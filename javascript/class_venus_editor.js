/**
* Constructor for venus.editor
* @constructor 
*/
function venus_editor()
{
	this.type = 'bbcode';
	this.name = '';
}
...
/**
* Returns true if the editor is a bbcode editor,false otherwise
*/
venus_editor.prototype.is_bbcode = function()
{
	if(this.type == 'bbcode')
		return true;
	else
...
venus_editor.prototype.resize_height = function(editor_id, height, padding)
{
	if(String(height).indexOf('%') != -1)
	{
		height = parseInt(height) * venus.get_window_height() / 100;
